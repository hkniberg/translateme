...
function getGitHubAccessToken(code) {
  var clientId = getGitClientId()
  var clientSecret = getGitClientSecret()

  const url = "https://github.com/login/oauth/access_token"
  const params = "client_id=" + clientId + "&client_secret=" + clientSecret + "&code=" + code
  console.log("data", params)
  try {
    const response = HTTP.call("POST", url, {headers: {"User-Agent": "translateme"}, data: params})
